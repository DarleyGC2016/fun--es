...
describe(`05 - ${listAvailable30MinuteSlotsMultiplePerson.name}`, () => {
  ...
  it('should return available slots between 9 and 13 Monday', () => {
    ...
    expect(result).toEqual([
      { start: new Date('2024-01-15T10:30:00Z'), durationM: 30 },
  ...
  it('should return available slots between 12 and 18 Tuesday', () => {
    ...
    // 7. 17:00 - 17:30
    expect(result).toEqual([
      { start: new Date('2024-01-16T14:00:00.000Z'), durationM: 30 },
      { start: new Date('2024-01-16T15:00:00.000Z'), durationM: 30 },
      { start: new Date('2024-01-16T16:00:00.000Z'), durationM: 30 },
      { start: new Date('2024-01-16T17:00:00.000Z'), durationM: 30 },
      { start: new Date('2024-01-16T17:30:00.000Z'), durationM: 30 },
      { start: new Date('2024-01-16T18:00:00.000Z'), durationM: 30 },
      { start: new Date('2024-01-16T15:00:00.000Z'), durationM: 30 },
      { start: new Date('2024-01-16T16:00:00.000Z'), durationM: 30 },
      { start: new Date('2024-01-16T17:30:00.000Z'), durationM: 30 },
      { start: new Date('2024-01-16T18:00:00.000Z'), durationM: 30 },
  ...
  it('should return available slots between 8 and 22 Wednesday', () => {
    ...
    // 6. 18:30 - 19:00
    expect(result).toEqual([
      { durationM: 30, start: new Date('2024-01-17T09:00:00.000Z') },
      { durationM: 30, start: new Date('2024-01-17T12:00:00.000Z') },
      { durationM: 30, start: new Date('2024-01-17T14:00:00.000Z') },
      { durationM: 30, start: new Date('2024-01-17T17:00:00.000Z') },
      { durationM: 30, start: new Date('2024-01-17T21:00:00.000Z') },
      { durationM: 30, start: new Date('2024-01-17T21:30:00.000Z') },
      { durationM: 30, start: new Date('2024-01-17T10:00:00.000Z') },
      { durationM: 30, start: new Date('2024-01-17T12:00:00.000Z') },
      { durationM: 30, start: new Date('2024-01-17T14:00:00.000Z') },
      { durationM: 30, start: new Date('2024-01-17T15:00:00.000Z') },
  ...
  it('should return available slots between 15 and 22 Thursday', () => {
    ...
    expect(result).toEqual([
      { durationM: 30, start: new Date('2024-01-18T15:00:00.000Z') },
      { durationM: 30, start: new Date('2024-01-18T18:00:00.000Z') },
      { durationM: 30, start: new Date('2024-01-18T18:00:00.000Z') },
      { durationM: 30, start: new Date('2024-01-18T20:00:00.000Z') },
      { durationM: 30, start: new Date('2024-01-18T20:00:00.000Z') },
      { durationM: 30, start: new Date('2024-01-18T22:00:00.000Z') },
    ]);
  });
});
