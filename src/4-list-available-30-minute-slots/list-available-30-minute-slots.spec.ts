...
describe(`04 - ${listAvailable30MinuteSlots.name}`, () => {
  ...
  it('should return available slots between 12 and 18 Tuesday', () => {
    ...
    // 7. 17:00 - 17:30
    expect(result).toEqual([
      { start: new Date('2024-01-16T14:00:00Z'), durationM: 30 },
      { start: new Date('2024-01-16T15:00:00Z'), durationM: 30 },
      { start: new Date('2024-01-16T16:00:00Z'), durationM: 30 },
      { start: new Date('2024-01-16T17:00:00Z'), durationM: 30 },
      { start: new Date('2024-01-16T17:30:00Z'), durationM: 30 },
      { start: new Date('2024-01-16T18:00:00Z'), durationM: 30 },
    ]);
  });
